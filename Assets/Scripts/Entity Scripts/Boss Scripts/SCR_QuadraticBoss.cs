...
{
    public class SCR_QuadraticBoss : SCR_BossEntity
    {
        [Header("QUADRATIC BOSS ANIMATOR PROPERTIES")] 
        [SerializeField] private bool isComplexBoss;
        [SerializeField] private RuntimeAnimatorController realQuadraticBoss;
        [SerializeField] private RuntimeAnimatorController complexQuadraticBoss;
        ...
        [SerializeField] SCR_EquationRenderer _equationRenderer;
        [SerializeField] float _quadraticSpeed = 12.5f;

        [Header("FOURTH PHASE COROUTINE")] 
        [SerializeField] private SCR_EntityShooting.ShootingVariant _shootingVariant = SCR_EntityShooting.ShootingVariant.DEFAULT;
        ...
        void Start()
        {
            ...
            _bossPhaseActions = new List<Action>() { FirstPhase, SecondPhase, ThirdPhase, FourthPhase };
            ...
            equationParentObject.SetParent(null);
        ...
        protected void Update()
        {
            if (animator)
            {
                animator.runtimeAnimatorController = isComplexBoss ? complexQuadraticBoss : realQuadraticBoss;
                
                bool attackingPhases = _bossPhase > 1;
                animator.SetBool("isAttacking", attackingPhases);
                animator.speed = _atHalfHP ? 2 : 1;
                
                spriteRenderer.color = BossHealthComponent.IsHalfHP ? new Color(255,100,100) : Color.white;
            }
        ...
        protected IEnumerator ThirdPhaseCoroutine()
        {
            _equationRenderer.ParentObject.gameObject.SetActive(true);
            _equationRenderer.SetPolynomialCoefficients(new List<float> { 0.5f, 0, 1.25f });
        ...
        private void FourthPhase()
        {
            ...
            _entityShooting.SetShootingStyle(_shootingVariant);
